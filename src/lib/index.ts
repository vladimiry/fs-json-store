...
import {FS_ERROR_CODE_EEXIST, FS_ERROR_CODE_ENOENT, MKDIR_MODE} from "./private/constants";
import {promisify} from "./private/util.promisify";
import {fs as defaultFs} from "./fs/fs";
import * as Model from "./model";

class Store<E extends Model.StoreEntity> implements Model.Store<E> {
